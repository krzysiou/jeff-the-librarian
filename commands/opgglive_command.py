...
class OPGGLIVE(commands.base_command.BaseCommand):
    ...
    async def handle(self, params, message, client):
        ...
        await message.channel.send(get_emoji(":game_die:")+"** Gamemode: **"+GameMode[0][0:13]+"\t"+get_emoji(":camping:")+"** Map: **"+MapName+"\t"+get_emoji(":hourglass:")+"** Time of start: **"+TimeEUNE+"\n\n"
            ...
            +get_emoji(":small_blue_diamond:")+f"** "+FriendNames[4]+"**\t"+get_emoji(":small_blue_diamond:")+f"** Rank: **"+TierF[4].lstrip().rstrip()+"\t"+get_emoji(":small_blue_diamond:")+f" **WinRate: **"+Wrf[4][0:8].lstrip().rstrip()+"\t"+get_emoji(":hourgsmall_blue_diamondlass:")+f"** Played Matches: **"+Wrf[4][9:15].strip()+"\n"
